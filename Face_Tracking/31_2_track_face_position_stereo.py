...
def full_code():
    ...
    while cam_r.isOpened() and cam_l.isOpened():
        ...
        if success_r == True:
           ret_right, nose_right=check_face_orientation(1, image_r,face_mesh1,mp_face_mesh1)
        #   ret_right, nose_right = check_face_orientation(1, image_r_rectifiyed, face_mesh1, mp_face_mesh1)
        if success_l == True:
           ret_left, nose_left=check_face_orientation(0, image_l,face_mesh2,mp_face_mesh2)
